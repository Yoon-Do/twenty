    ...
    .values([
      {
        ...
        firstName: 'Nam',
        lastName: 'Do',
        email: 'nam.do@salegon.com',
        passwordHash:
          '$2b$10$5q5AfRFGBQ6bwN.0eVYb2OByUOacQSlhubqRIJbdFd66fSsUofBB2', // salegon@####
        canImpersonate: true,
      ...
      },
      {
        ...
        firstName: 'Thinh',
        lastName: 'Nguyen',
        email: 'thinh.nguyen@salegon.com',
        passwordHash:
          '$2b$10$5q5AfRFGBQ6bwN.0eVYb2OByUOacQSlhubqRIJbdFd66fSsUofBB2', // salegon@####
        canImpersonate: true,
        canAccessFullAdminPanel: true,
